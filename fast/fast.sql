...
) ENGINE = InnoDB AUTO_INCREMENT = 2005 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '系统管理员', '00', 'huacai@163.com', '15888888888', '1', '', 'admin123', '0', '0', '127.0.0.1', '2025-12-06 16:53:41', 'admin', '2025-08-30 08:59:53', '', '2025-12-06 16:53:41', '管理员');
